...
class History():
    def __init__(self):
        ...
        self.historyteacher_image = pygame.image.load("assets/history_teacher.png")
    ...
    def draw1(self):
        ...
        self.screen.blit(self.historyteacher_image, (0, 0))  # Draw teacher image
    ...
    def draw2(self):
        self.screen.fill((255, 255, 255))  # Clear the screen
        self.screen.blit(self.mathteacher_image, (0, 0))  # Draw teacher image
